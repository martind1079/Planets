...
The app compostion is done in the SceneDelegate and better use could be made of injection containers to keep this tidy. As features grow I would aim to use an injection container strategy and flesh out relevant scopes for object lifetimes. 
